...
# Change the logo script URL to your custom one or remove it if not needed
curl -s https://raw.githubusercontent.com/rumeyst/logo/main/logo.sh | bash
sleep 5
...
read -p "Enter the token symbol (e.g., MYT): " TOKEN_SYMBOL
...
if ! command -v forge &> /dev/null; then
    ...
    source <(wget -O - https://raw.githubusercontent.com/rumeyst/installation/main/foundry.sh)
fi
